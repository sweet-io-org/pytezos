...
class MainnetContractTestCaseTDG_GROWL_AUCTION(TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_parameter_type_tdg_growl_auction(self):
    ...
    def test_entrypoints_tdg_growl_auction(self):
    ...
    def test_storage_type_tdg_growl_auction(self):
    ...
    def test_storage_encoding_tdg_growl_auction(self):
