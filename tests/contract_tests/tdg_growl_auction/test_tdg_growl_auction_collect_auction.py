...
class MainnetOperationTestCaseTDG_GROWL_AUCTION(TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'collect_auction.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'collect_auction'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_tdg_growl_auction(self):
    ...
    def test_lazy_storage_tdg_growl_auction(self):
