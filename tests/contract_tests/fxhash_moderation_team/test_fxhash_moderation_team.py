...
class MainnetContractTestCaseFXHASH_MODERATION_TEAM(TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_parameter_type_fxhash_moderation_team(self):
    ...
    def test_entrypoints_fxhash_moderation_team(self):
    ...
    def test_storage_type_fxhash_moderation_team(self):
    ...
    def test_storage_encoding_fxhash_moderation_team(self):
