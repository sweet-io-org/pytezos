...
class MainnetOperationTestCaseFXHASH_MODERATION_TEAM(TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'update_moderators.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'update_moderators'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_fxhash_moderation_team(self):
    ...
    def test_lazy_storage_fxhash_moderation_team(self):
