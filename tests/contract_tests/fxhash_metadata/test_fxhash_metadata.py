...
class MainnetContractTestCaseFXHASH_METADATA(TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_parameter_type_fxhash_metadata(self):
    ...
    def test_entrypoints_fxhash_metadata(self):
    ...
    def test_storage_type_fxhash_metadata(self):
    ...
    def test_storage_encoding_fxhash_metadata(self):
