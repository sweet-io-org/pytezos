...
class MainnetOperationTestCaseWETH_E_CTEZ_PLENTY_VOLATILE_SWAP(TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_parameters_weth_e_ctez_plenty_volatile_swap(self):
    ...
    def test_lazy_storage_weth_e_ctez_plenty_volatile_swap(self):
