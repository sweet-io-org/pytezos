...
class MainnetContractTestCaseWETH_E_CTEZ_PLENTY_VOLATILE_SWAP(TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_parameter_type_weth_e_ctez_plenty_volatile_swap(self):
    ...
    def test_entrypoints_weth_e_ctez_plenty_volatile_swap(self):
    ...
    def test_storage_type_weth_e_ctez_plenty_volatile_swap(self):
    ...
    def test_storage_encoding_weth_e_ctez_plenty_volatile_swap(self):
