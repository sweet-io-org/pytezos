...
class MainnetContractTestCaseTZPIXELS(TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_parameter_type_tzpixels(self):
    ...
    def test_entrypoints_tzpixels(self):
    ...
    def test_storage_type_tzpixels(self):
    ...
    def test_storage_encoding_tzpixels(self):
