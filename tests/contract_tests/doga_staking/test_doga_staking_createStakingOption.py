...
class MainnetOperationTestCaseDOGA_STAKING(TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'createStakingOption.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'createStakingOption'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_doga_staking(self):
    ...
    def test_lazy_storage_doga_staking(self):
