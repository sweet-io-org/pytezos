...
class MainnetContractTestCaseDOGA_STAKING(TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_parameter_type_doga_staking(self):
    ...
    def test_entrypoints_doga_staking(self):
    ...
    def test_storage_type_doga_staking(self):
    ...
    def test_storage_encoding_doga_staking(self):
