...
class MainnetOperationTestCaseUSDT_E_USDC_E_FARM(TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'changeAdmin.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'changeAdmin'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_usdt_e_usdc_e_farm(self):
    ...
    def test_lazy_storage_usdt_e_usdc_e_farm(self):
