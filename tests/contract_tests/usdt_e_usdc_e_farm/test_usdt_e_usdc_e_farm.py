...
class MainnetContractTestCaseUSDT_E_USDC_E_FARM(TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_parameter_type_usdt_e_usdc_e_farm(self):
    ...
    def test_entrypoints_usdt_e_usdc_e_farm(self):
    ...
    def test_storage_type_usdt_e_usdc_e_farm(self):
    ...
    def test_storage_encoding_usdt_e_usdc_e_farm(self):
