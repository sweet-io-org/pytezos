...
class MainnetContractTestCaseFXHASH_MODERATION_TOKEN(TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_parameter_type_fxhash_moderation_token(self):
    ...
    def test_entrypoints_fxhash_moderation_token(self):
    ...
    def test_storage_type_fxhash_moderation_token(self):
    ...
    def test_storage_encoding_fxhash_moderation_token(self):
