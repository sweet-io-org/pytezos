...
class MainnetOperationTestCaseFXHASH_MODERATION_TOKEN(TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'set_addresses.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'set_addresses'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_fxhash_moderation_token(self):
    ...
    def test_lazy_storage_fxhash_moderation_token(self):
