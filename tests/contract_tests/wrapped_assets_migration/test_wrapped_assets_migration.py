...
class MainnetContractTestCaseWRAPPED_ASSETS_MIGRATION(TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_parameter_type_wrapped_assets_migration(self):
    ...
    def test_entrypoints_wrapped_assets_migration(self):
    ...
    def test_storage_type_wrapped_assets_migration(self):
    ...
    def test_storage_encoding_wrapped_assets_migration(self):
