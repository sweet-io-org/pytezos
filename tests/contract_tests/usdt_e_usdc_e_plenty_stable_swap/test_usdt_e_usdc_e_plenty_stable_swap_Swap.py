...
class MainnetOperationTestCaseUSDT_E_USDC_E_PLENTY_STABLE_SWAP(TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'Swap.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'Swap'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_usdt_e_usdc_e_plenty_stable_swap(self):
    ...
    def test_lazy_storage_usdt_e_usdc_e_plenty_stable_swap(self):
