...
class MainnetOperationTestCaseTYPED_MINTER(TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'mint_TYPED.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'mint_TYPED'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_typed_minter(self):
    ...
    def test_lazy_storage_typed_minter(self):
