...
class MainnetContractTestCaseTYPED_MINTER(TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_parameter_type_typed_minter(self):
    ...
    def test_entrypoints_typed_minter(self):
    ...
    def test_storage_type_typed_minter(self):
    ...
    def test_storage_encoding_typed_minter(self):
