...
class MainnetContractTestCaseAKASWAP_RAFFLE_EVENT(TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_parameter_type_akaswap_raffle_event(self):
    ...
    def test_entrypoints_akaswap_raffle_event(self):
    ...
    def test_storage_type_akaswap_raffle_event(self):
