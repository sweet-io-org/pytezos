...
class MainnetContractTestCaseCTEZ_TEZ_PLENTY_STABLE_SWAP(TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_parameter_type_ctez_tez_plenty_stable_swap(self):
    ...
    def test_entrypoints_ctez_tez_plenty_stable_swap(self):
    ...
    def test_storage_type_ctez_tez_plenty_stable_swap(self):
    ...
    def test_storage_encoding_ctez_tez_plenty_stable_swap(self):
