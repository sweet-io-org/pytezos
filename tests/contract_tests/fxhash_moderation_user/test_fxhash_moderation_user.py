...
class MainnetContractTestCaseFXHASH_MODERATION_USER(TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_parameter_type_fxhash_moderation_user(self):
    ...
    def test_entrypoints_fxhash_moderation_user(self):
    ...
    def test_storage_type_fxhash_moderation_user(self):
    ...
    def test_storage_encoding_fxhash_moderation_user(self):
