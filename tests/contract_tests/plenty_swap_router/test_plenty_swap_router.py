...
class MainnetContractTestCasePLENTY_SWAP_ROUTER(TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_parameter_type_plenty_swap_router(self):
    ...
    def test_entrypoints_plenty_swap_router(self):
    ...
    def test_storage_type_plenty_swap_router(self):
    ...
    def test_storage_encoding_plenty_swap_router(self):
