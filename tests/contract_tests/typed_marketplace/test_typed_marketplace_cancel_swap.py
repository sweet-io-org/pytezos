...
class MainnetOperationTestCaseTYPED_MARKETPLACE(TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'cancel_swap.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'cancel_swap'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_typed_marketplace(self):
    ...
    def test_lazy_storage_typed_marketplace(self):
