...
class MainnetOperationTestCaseQUIPUSWAP_STABLESWAP_AMM_FACTORY(TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        with open(join(dirname(__file__), f'', f'set_admin_function.json')) as f:
            operation = json.loads(f.read())

        cls.entrypoint = f'set_admin_function'
        cls.operation = operation
        # cls.maxDiff = None

    def test_parameters_quipuswap_stableswap_amm_factory(self):
    ...
    def test_lazy_storage_quipuswap_stableswap_amm_factory(self):
