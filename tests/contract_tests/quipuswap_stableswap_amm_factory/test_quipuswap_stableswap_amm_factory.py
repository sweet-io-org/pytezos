...
class MainnetContractTestCaseQUIPUSWAP_STABLESWAP_AMM_FACTORY(TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_entrypoints_quipuswap_stableswap_amm_factory(self):
    ...
    def test_storage_encoding_quipuswap_stableswap_amm_factory(self):
